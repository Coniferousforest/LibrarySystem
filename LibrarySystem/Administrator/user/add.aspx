<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="add.aspx.cs" Inherits="Administrator_user_add" %>
     ...
     <div class="outerBar">
        <table align="left" cellspacing="3" class="innerBar">
            <thead>
             ...
             <tbody>
                <tr>
                    <td class="first">学号/工号：</td>
                    <td class="second">
                        <asp:TextBox ID="TextBox1" runat="server" class="box" AutoPostBack="True" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
                ...
                <tr>
                 ...
                 <tr>
                     <td colspan = "2" class="subBtn">
                 	    <asp:Button ID="Button1" runat="server" Text="提交" class="btn" OnClick="Button2_Click"/>
                     </td>
                 </tr>
            </tbody>
        </table>
