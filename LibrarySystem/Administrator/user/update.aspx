<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="update.aspx.cs" Inherits="Administrator_user_update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" Width="950px" AutoGenerateColumns="False" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand">
             ...
             <Columns>
                  ...
                  <asp:BoundField DataField="leve" HeaderText="级别" />
                  <asp:BoundField DataField="phone" HeaderText="电话" />
               

                  <asp:TemplateField HeaderText="">  
                  <ItemTemplate>  
                      <a href='userdetail.aspx?Id=<%#Eval("username")%>'>修改</a>
                  </ItemTemplate>  
