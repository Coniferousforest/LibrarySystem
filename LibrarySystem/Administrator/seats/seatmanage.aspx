<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="seatmanage.aspx.cs" Inherits="Administrator_seats_seatmanage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    <div style="margin:40px">
          <asp:GridView  ID="GridView1" runat="server" AllowPaging="True" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" EmptyDataText="-" HorizontalAlign="Center" Width="950px">
              <AlternatingRowStyle BackColor="White" />
              <Columns>

                  <asp:BoundField DataField="ID" HeaderText="座位编号" >
                  <ItemStyle HorizontalAlign="Center" />
                  </asp:BoundField>
                  <asp:BoundField DataField="IsSitting" HeaderText="是否可选" >
                  <ItemStyle HorizontalAlign="Center" />
                  </asp:BoundField>
                  <asp:BoundField DataField="SitingTime" HeaderText="选座时间" />
                  <asp:BoundField DataField="SittingPeple" HeaderText="选座人" />
                    <asp:ButtonField CommandName="del" Text="释放" />
              </Columns>
